...
<div>
    <x-table :columns="['image', 'title_ar', 'title_en', 'desc_ar', 'desc_en',  'link']">
    ...
    <x-modal wireAction="store" id="addModal" title="{{ __('dash.add') }}" type="primary">
        <div class="row">
            ...
            <x-form.input name="desc_ar" label="{{ __('dash.desc_ar') }}"></x-form.input>
            <x-form.input name="desc_en" label="{{ __('dash.desc_en') }}"></x-form.input>
