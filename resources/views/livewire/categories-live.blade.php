...
<div>
                    ...
                    <tbody class="text-center">
                        @foreach ($category->subs as $sub_category)
                            <tr Role="row" class="odd">
                                ...
                                <td>
                                    <a href="{{ route('dashboard.services', $sub_category->id) }}" type="button">
    ...
    {{-- Add addModalParent--}}
    <x-modal wireAction="storeParent" id="addAssignedModal" title="{{ __('dash.add') }}" type="primary" addNew>
        <div class="row">
    ...
    {{-- Add Chield --}}
    <x-modal wireAction="storeChield" id="addModal" title="{{ $modal_title ?? '' }}"  type="primary" addNew>
        <div class="row">
            <x-form.input name="title_ar" label="{{ __('dash.title_ar') }}"></x-form.input>
            <x-form.input name="title_en" label="{{ __('dash.title_en') }}"></x-form.input>
        </div>
